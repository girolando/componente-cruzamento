...
class DatabaseEntityService extends ServiceAbstract implements ComponentServiceContract
{
    ...
    public function getDataset($dataTableQueryName)
    {
        ...
        */
       $dataset->select('id','codigoCruzamento','codigoComunicacao','numeroComunicacao','codigoAntigoComunicacao','codigoMatriz','nomeMatriz','registroMatriz','sangueMatriz','codigoReprodutor','nomeReprodutor', 'registroReprodutor', 'sangueReprodutor', 'codigoSecreto', 'dataCruzamento', 'statusCruzamento', 'codigoCruzamentoAutorizado', 'statusCruzamentoAutorizado', 'tipoComunicacao', 'codigoPessoaComunicacao', 'codigoPessoaAutorizada', 'qtdFilhos', 'qtdViavelEmbriao', 'qtdImplantada', 'cruzamentoEmAguardo', 'possuiReceptorasParaUso')->distinct();
		return $dataset;
    }
